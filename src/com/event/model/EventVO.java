...
public class EventVO implements Serializable {
	...
	public String toString() {
		return "EventVO [event_id=" + event_id + ", band_id=" + band_id + ", event_type=" + event_type + ", event_sort="
				+ event_sort + ", event_title=" + event_title + ", event_detail=" + event_detail + ", event_poster="
				+ Arrays.toString(event_poster) + ", event_area=" + event_area + ", event_place=" + event_place
				+ ", event_city=" + event_city + ", event_cityarea=" + event_cityarea + ", event_address="
				+ event_address + ", event_start_time=" + event_start_time + ", event_on_time=" + event_on_time
				+ ", event_last_edit_time=" + event_last_edit_time + ", event_last_editor=" + event_last_editor
				+ ", event_status=" + event_status + ", event_seat=" + Arrays.toString(event_seat) + "]";
	}
