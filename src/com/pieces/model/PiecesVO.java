...
public class PiecesVO implements Serializable{
	...
	public String toString() {
		return "PiecesVO [piece_id=" + piece_id + ", album_id=" + album_id + ", piece=" + Arrays.toString(piece)
				+ ", piece_status=" + piece_status + ", piece_play_count=" + piece_play_count + ", piece_add_time="
				+ piece_add_time + ", piece_last_edit_time=" + piece_last_edit_time + ", piece_last_editor="
				+ piece_last_editor + "]";
	}
