...
public class TicketVO implements Serializable {
	...
	public String toString() {
		return "TicketVO [ticket_id=" + ticket_id + ", event_id=" + event_id + ", ticket_sort=" + ticket_sort
				+ ", ticket_name=" + ticket_name + ", ticket_amount=" + ticket_amount + ", ticket_price=" + ticket_price
				+ ", ticket_endsale_time=" + ticket_endsale_time + ", ticket_edit_time=" + ticket_edit_time
