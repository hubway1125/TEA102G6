...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/back-end/pieces/index_pieces.jsp"><img src="<%=request.getContextPath()%>/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
	...
	<table>
		...
		<tr>
			...
			<td><fmt:formatDate value="${piecesVO.piece_add_time}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
			<td><fmt:formatDate value="${piecesVO.piece_last_edit_time}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
